...
Namespace WindowsApplication1
	...
	Partial Public Class DataSet1
		...
		Partial Public Class DataTable1DataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddDataTable1Row(ByVal Column1 As String, ByVal Column2 As String) As DataTable1Row
				Dim rowDataTable1Row As DataTable1Row = (CType(Me.NewRow(), DataTable1Row))
				Dim columnValuesArray() As Object = { Column1, Column2}
		...
		Partial Public Class DataTable1Row
			...
			Public Property Column1() As String
				Get
					Try
						Return (CStr(Me(Me.tableDataTable1.Column1Column)))
			...
			Public Property Column2() As String
				Get
					Try
						Return (CStr(Me(Me.tableDataTable1.Column2Column)))
					Catch e As Global.System.InvalidCastException
